...
instructions.forEach((commands) => {
  commands.split('').forEach((command) => {
    if ( command === 'U' && finger[0] > 0 && keypad[finger[0] - 1][finger[1]] !== 0 ) finger[0]--;
    if ( command === 'D' && finger[0] < 4 && keypad[finger[0] + 1][finger[1]] !== 0 ) finger[0]++;
    if ( command === 'L' && finger[1] > 0  && keypad[finger[0]][finger[1] - 1] !== 0) finger[1]--;
    if ( command === 'R' && finger[1] < 4 && keypad[finger[0]][finger[1] + 1] !== 0 ) finger[1]++;
  });
